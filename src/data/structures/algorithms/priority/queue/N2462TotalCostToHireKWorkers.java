...
public class N2462TotalCostToHireKWorkers {
...
/*
You are given a 0-indexed integer array costs where costs[i]
...
worker with the lowest cost among them. Break the tie by the
smallest index.
