...
public class getRemovableIndices {
    ...
    public static void main(String[] args) {
        System.out.println("value : " + getRemovableIndices("abdgggda", "abdggda"));
        System.out.println("value : " + getRemovableIndices("mmgghh", "mfggh"));
        System.out.println("value : " + getRemovableIndices("aabbb", "aabb"));
    }
}
