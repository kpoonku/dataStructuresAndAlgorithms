...
/*
Great question! This is a classic **greedy algorithm** problem that’s very similar in spirit to the **non-overlapping intervals** problem you asked earlier.
...
### 🎯 The Problem:
You have a list of balloons floating on a wall. Each balloon is described by its **horizontal range**: `[xstart, xend]`.
You can shoot **arrows vertically**, and an arrow at position `x` will **burst all balloons where** `xstart <= x <= xend`.
...
Let me know if you want to see a **visual diagram**, or how this compares to the interval removal problem!
 */