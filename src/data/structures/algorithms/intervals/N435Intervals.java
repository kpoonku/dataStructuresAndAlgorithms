 ...
 */
/*
Great question! You're being asked to **remove the minimum number of intervals** from
a list so that **none of the remaining intervals overlap**.
...
[1,2], [2,3], [3,4], [1,3]
```
Some of these intervals **overlap**, and your job is to remove as few as possible
so that all the remaining intervals are non-overlapping.
---
